...
<div class="nav w1200">
    ...
    <div class="kj-show2">
        <div class="kj-info1" mg="shiping" th:mg="|shiping${producttype.id}|" th:each="producttype : ${list}" th:if="${producttype.pid==0}">
            <dl class="kj-dl1">
                <!--一级标题-->
                <dt><a href="#" th:text="${producttype.name}">食品/饮料/酒水</a></dt>

            </dl>
            <div class="kj-if-show" mg2="shiping" th:mg2="|shiping${producttype.id}|">
                <dl th:each="producttype2 : ${list}" th:if="${producttype2.pid==producttype.id}">
                    <!--二级标题-->
                    <dt th:text="${producttype2.name}">零食/糖果/巧克力</dt>
                    <dd>
                        <!--三级标题-->
                        <a href="#" th:each="producttype3 : ${list}" th:if="${producttype3.pid==producttype2.id}" th:text="${producttype3.name}">坚果迷线</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
            </div>
